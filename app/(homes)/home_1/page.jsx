            ...
            <div className="col-auto">
              <div className="sectionTitle -md">
                ...
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                  {t("These popular destinations have a lot to offer")}
                </p>
              </div>
            </div>
            {/* End col-auto */}
      ...
      <section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-10 justify-between items-end">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">{t("Recommended")}</h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                  {t("Interdum et malesuada fames ac ante ipsum")}
                </p>
              </div>
            </div>
        ...
        <div className="container">
          <div className="row justify-center text-center">
            <div className="col-auto">
              <div className="sectionTitle -md">
                <h2 className="sectionTitle__title">
                  {t("Get inspiration for your next trip")}
                </h2>
                <p className=" sectionTitle__text mt-5 sm:mt-0">
                  {t("Interdum et malesuada fames")}
                </p>
              </div>
            </div>
          </div>
