            ...
            <div className="row x-gap-20 y-gap-20">
              ...
              <div className="col-md">
                <h3 className="text-18 lh-16 fw-500">
                  {t(item?.title)}
                  <br className="lg:d-none" /> {t(item?.location)}
                ...
                <div className="row x-gap-10 y-gap-10 items-center pt-10">
                  <div className="col-auto">
                    <p className="text-14">{t(item?.location)}</p>
                  </div>
                  ...
                  <div className="col-auto">
                    <p className="text-14">{t("2 km to city center")}</p>
                  </div>
                </div>

                <div className="text-14 lh-15 mt-20">
                  <div className="fw-500">{t("King Room")}</div>
                  <div className="text-light-1">{t("1 extra-large double bed")}</div>
                </div>

                <div className="text-14 text-green-2 lh-15 mt-10">
                  <div className="fw-500">{t("Free cancellation")}</div>
                  <div className="">
              ...
              <div className="col-md-auto text-right md:text-left">
                <div className="row x-gap-10 y-gap-10 justify-end items-center md:justify-start">
                  <div className="col-auto">
                    <div className="text-14 lh-14 fw-500">{t("Exceptional")}</div>
