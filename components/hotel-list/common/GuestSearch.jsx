  ...
  return (
    <div className="searchMenu-guests px-20  lg:py-20 lg:px-0 js-form-dd bg-white position-relative">
      <div
        ...
        data-bs-offset="0,22"
      >
        <h4 className="text-15 fw-500 ls-2 lh-16">{t("Guest")}</h4>
        <div className="text-15 text-light-1 ls-2 lh-16">
          <span className="js-count-adult">{guestCounts.Adults}</span> {t("Adults")} -{" "}
          <span className="js-count-child">{guestCounts.Children}</span>{" "}
          {t("Children")} - <span className="js-count-room">{guestCounts.Rooms}</span>{" "}
          {t("room")}
        </div>
      </div>
      {/* End guest */}
